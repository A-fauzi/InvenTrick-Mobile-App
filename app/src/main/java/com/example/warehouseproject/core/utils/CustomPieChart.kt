...
class CustomPieChart(pieChart: PieChart, val circleRadius: Float): PieChartRenderer(pieChart, pieChart.animator, pieChart.viewPortHandler) {
    override fun drawValues(c: Canvas?) {
        ...
        if (mChart.isDrawHoleEnabled) {
            labelRadiusOffset = (radius - radius * holeRadiusPercent)
